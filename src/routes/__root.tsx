  ...
  head: () => ({
    ...
    links: [
      ...
      },
      {
        ...
        sizes: '180x180',
        href: '/apple-touch-icon.png?v=mididraft-c',
      },
      {
        rel: 'icon',
        type: 'image/png',
        sizes: '32x32',
        href: '/favicon-32x32.png?v=mididraft-c',
      },
      {
        rel: 'icon',
        type: 'image/png',
        sizes: '16x16',
        href: '/favicon-16x16.png?v=mididraft-c',
      },
      { rel: 'icon', href: '/favicon.ico?v=mididraft-c' },
      {
        rel: 'icon',
        type: 'image/svg+xml',
        sizes: 'any',
        href: '/favicon.svg?v=mididraft-c',
      },
      { rel: 'manifest', href: '/manifest.json?v=mididraft-c' },
    ],
  }),
